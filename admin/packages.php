...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if ($stmt->execute()) {
            setFlashMessage('message', 'Paket berhasil dihapus.', 'alert alert-success');
        } else {
            setFlashMessage('message', 'Terjadi kesalahan saat menghapus paket.', 'alert alert-danger');
        }
    } else {
        ...
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    ...
                    <a href="package-add.php" class="btn btn-primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="package-facilities.php?id=<?php echo $package['id']; ?>" class="btn btn-sm btn-info">
                                                                <i class="fas fa-list"></i>
                                                            </a>
                                                            <a href="packages.php?action=delete&id=<?php echo $package['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus paket ini?')">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="package-categories.php" class="btn btn-sm btn-primary">
