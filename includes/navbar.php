...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    <a href="<?php echo (strpos($_SERVER['PHP_SELF'], '/user/') !== false || strpos($_SERVER['PHP_SELF'], '/admin/') !== false) ? '../index.php' : 'index.php'; ?>" class="navbar-brand p-0 d-flex align-items-center">
        <img src="<?php echo (strpos($_SERVER['PHP_SELF'], '/user/') !== false || strpos($_SERVER['PHP_SELF'], '/admin/') !== false) ? '../img/logo.png' : 'img/logo.png'; ?>" alt="Tirta Sanita Outbound Logo" style="height: 50px; width: auto; margin-right: 12px;">
        <h1 class="m-0 text-primary d-none d-md-inline-block">Tirta Sanita Outbound</h1>
        <h6 class="m-0 text-primary d-md-none">Tirta Sanita</h6>
    </a>
